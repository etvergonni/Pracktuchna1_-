...
public partial class Student : Person, ICloneable
{
    ...
    public List<Shape> Projects { get; } = new();
    ...
    public void AddProject(Shape shape) => Projects.Add(shape);

    public StudentRecord GetRecord() => new StudentRecord(FullName, RecordBookNumber, AverageGrade);
